...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { clinic_id: @employment.clinic_id, creator: @employment.creator, professional_id: @employment.professional_id }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { clinic_id: @employment.clinic_id, creator: @employment.creator, professional_id: @employment.professional_id }
    assert_redirected_to employment_path(assigns(:employment))
  end
